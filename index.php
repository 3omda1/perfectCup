    ...
    <div class="container">
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12 text-center">
                    ...
                    <h2>
                        <small>By
                            <strong><a href="https://www.facebook.com/profile.php?id=100007795414563">Ahmed Emad</a></strong>
                        </small>
                    </h2>
                </div>
            </div>
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
                    <hr>
                    <h2 class="intro-text text-center"><strong>How to make the perfect cup of coffee</strong>
                    </h2>
                    <hr>
